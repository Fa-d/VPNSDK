...
//
//import app.kloud.activity.DemoActivity;
//import app.kloud.vpn.R;
...
//    private static final String NOTIFICATION_CHANNEL_ID = "symlex-outline-vpn";
...
//                Log.e("Network","Network change");
//                return;
//            }
//            OutlinePlugin.updateState(OutlinePlugin.TunnelStatus.CONNECTED);
...
//        Intent launchIntent = new Intent(this, DemoActivity.class);
//        PendingIntent mainActivityIntent = null;
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//            mainActivityIntent = PendingIntent.getActivity(this, 0, launchIntent,  PendingIntent.FLAG_IMMUTABLE|PendingIntent.FLAG_UPDATE_CURRENT);
//        } else {
//            mainActivityIntent = PendingIntent.getActivity(this, 0, launchIntent, 0);
//        }
//
//        Notification.Builder builder;
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
//            NotificationChannel channel = new NotificationChannel(
//                    NOTIFICATION_CHANNEL_ID, "symlex_vpn_outline", NotificationManager.IMPORTANCE_DEFAULT);
...
//                .setSmallIcon(R.drawable.ic_stat_sym)
//                .setShowWhen(true)
...
//        OutlinePlugin.updateState(OutlinePlugin.TunnelStatus.DISCONNECTED);
...
//        try {
//            return Class.forName(getPackageName() + ".DemoActivity");
//        } catch (Exception e) {
