...
public class LogItem implements Parcelable {
    ...
    VpnStatusOC.LogLevel mLevel = VpnStatusOC.LogLevel.INFO;
    ...
    public LogItem(VpnStatusOC.LogLevel level, int verblevel, String message) {
        mMessage = message;
        mLevel = level;
        ...
        if (mArgs == null || mArgs.length == 0) {
            ...
            for (Object o : mArgs) {
                if (o instanceof String) {
                    ...
                    VpnStatusOC.logDebug("Unknown object for LogItem marschaling " + o);
                    bb.putChar('s');
    ...
    public LogItem(byte[] in, int length) throws UnsupportedEncodingException {
        ...
        mLevel = VpnStatusOC.LogLevel.getEnumByValue(bb.getInt());
    ...
    public LogItem(Parcel in) {
        ...
        mLevel = VpnStatusOC.LogLevel.getEnumByValue(in.readInt());
    ...
    public LogItem(VpnStatusOC.LogLevel loglevel, int ressourceId, Object... args) {
        mRessourceId = ressourceId;
        mArgs = args;
        mLevel = loglevel;
    }
    ...
    public LogItem(VpnStatusOC.LogLevel loglevel, String msg) {
        mLevel = loglevel;
        mMessage = msg;
    }


    public LogItem(VpnStatusOC.LogLevel loglevel, int ressourceId) {
        mRessourceId = ressourceId;
        mLevel = loglevel;
    }
    ...
    public VpnStatusOC.LogLevel getLogLevel() {
        return mLevel;
    }
    ...
    private String getMobileInfoString(Context c) {
        ...
        try {
            ...
            if (Arrays.equals(digest, VpnStatusOC.officalkey))
                apksign = c.getString(R.string.official_build);
            else if (Arrays.equals(digest, VpnStatusOC.officaldebugkey))
                apksign = c.getString(R.string.debug_build);
            else if (Arrays.equals(digest, VpnStatusOC.amazonkey))
                apksign = "amazon version";
            else if (Arrays.equals(digest, VpnStatusOC.fdroidkey))
