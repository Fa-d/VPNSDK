//package de.blinkt.openconnect.api;
//
...
//
//	private OpenConnectService mService;
...
//			OpenConnectService.LocalBinder binder = (OpenConnectService.LocalBinder) service;
...
//			shortVPNIntent.setClass(getBaseContext(),de.blinkt.openconnect.LaunchVPN.class);
//			shortVPNIntent.putExtra(de.blinkt.openconnect.LaunchVPN.EXTRA_KEY,profileUUID);
...
//
//
//				OpenVpnProfileManager.setTemporaryProfile(vp);
...
//				VpnProfile vp = cp.convertProfile();
//				vp.mName = name;
//				OpenVpnProfileManager pm = OpenVpnProfileManager.getInstance(getBaseContext());
//				pm.addProfile(vp);
//			} catch (IOException e) {
//				e.printStackTrace();
//				return false;
