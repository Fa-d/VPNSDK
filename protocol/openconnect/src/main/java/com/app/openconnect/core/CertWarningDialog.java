...
public class CertWarningDialog extends UserDialog implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onStart(Context context) {
        ...
        mAlert = new AlertDialog.Builder(context).setTitle(R.string.cert_warning_title).setMessage(context.getString(R.string.cert_warning_message, mHostname, mReason, mCertSHA1)).setPositiveButton(R.string.cert_warning_always_connect, this).setNeutralButton(R.string.cert_warning_just_once, this).setNegativeButton(R.string.no, this).create();
