...
public class Statistics {
     ...
     * @param rx  The received traffic for the {@link Peer} referenced by
     *            the provided {@link Key}. This value is in bytes
     * @param tx  The transmitted traffic for the {@link Peer} referenced by
     *            the provided {@link Key}. This value is in bytes.
     */
    ...
    /**
     * Get the received traffic (in bytes) for the {@link Peer} referenced by
     * the provided {@link Key}
     *
     * @param peer A {@link Key} representing a {@link Peer}.
    ...
    /**
     * Get the transmitted traffic (in bytes) for the {@link Peer} referenced by
     * the provided {@link Key}
     *
     * @param peer A {@link Key} representing a {@link Peer}.
