...
import com.faddy.singbox.utils.HTTPClient
import java.io.File
    ...
    companion object {
        ...
        private suspend fun reconfigureUpdater0() {
            ...
            if (remoteProfiles.isEmpty()) {
                WorkManager.getInstance(CustomApplication.application!!).cancelUniqueWork(WORK_NAME)
                return
            }
            ...
            WorkManager.getInstance(CustomApplication.application!!).enqueueUniquePeriodicWork(
                WORK_NAME,
